...
├── fig1_hazard_exposure.py                                        # Python scripts for main analysis (Figs. 1-5 and Table 1)
...
├── GEE_code_future_flood_projection.js                            # Google Earth Engine scripts for future hazard projection
└── GEE_code_future_heat_projection.js                             
...
| `GEE_code_future_flood_projection.js` | RF model training and future flood duration projection | Future flood duration images exported to GEE assets |
| `GEE_code_future_heat_projection.js` | RF model training and future extreme heat days projection | Future extreme heat days images exported to GEE assets |
